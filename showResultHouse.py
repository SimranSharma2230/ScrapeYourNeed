...
class ShowResult(Frame):
    ...
    def init_window(self):
        ...
        tree = ttk.Treeview(TableMargin, columns=("Title","Location","Price","Detail"), height=400, selectmode="extended", yscrollcommand=scrollbary.set, xscrollcommand=scrollbarx.set)
        ...
        with open(self.csvFile) as f:
            ...
            for row in reader:
                ...
                detail = row['Detail']
                #Location = row['Location']
                tree.insert("", 0, values=(title, location, price,detail))
